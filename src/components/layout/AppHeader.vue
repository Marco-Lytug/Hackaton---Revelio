  ...
  <header :class="{ hidden: isHidden, transparent: isTop }">
    <nav class="desktop-nav">
      <ul class="principal">
        ...
        <li> <RouterLink to="/perfilUser" class="icone-perfil">
    ...
    <nav class="mobile-nav">
      <ButtonChild class="hamburguer" @clique="abrirMenu = !abrirMenu"> ☰ </ButtonChild>
      ...
      <Transition name="modal-tudo">
        <div v-if="abrirMenu" class="modal-nav" @click="abrirMenu = false">
          <ul class="menu-mobile" @click.stop>
            ...
            <li>
              <a @click.prevent="abrirLivros = !abrirLivros"> Livros </a>
