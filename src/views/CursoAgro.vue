...
<template>
  ...
  <section class="principal">
    ...
    <div class="video-container">
      <div class="video">
        <h3></h3>
        <video controls src="/public/videos/agro1.mp4" @ended="marcarComoAssistido(1)"></video>
      </div>

      <div class="video">
        <h3></h3>
        <video controls src="/public/videos/agro2.mp4" @ended="marcarComoAssistido(2)"></video>
      </div>

      <div class="video">
        <h3></h3>
        <video controls src="/public/videos/agro3.mp4" @ended="marcarComoAssistido(3)"></video>
      </div>

      <div class="video">
        <h3></h3>
        <video controls src="/public/videos/agro4.mp4" @ended="marcarComoAssistido(4)"></video>
      </div>
    </div>
  </section>
</template>
