...
<template>
  ...
  <section class="principal">
    ...
    <div class="video-container">
      ...
      <div class="video">
        <h3></h3>
        <video controls src="/videos/html.mp4" @ended="marcarComoAssistido(2)"></video>
      </div>

      <div class="video">
        <h3></h3>
        <video controls src="/videos/django.mp4" @ended="marcarComoAssistido(3)"></video>
      </div>

      <div class="video">
        <h3></h3>
        <video controls src="/videos/vue3.mp4" @ended="marcarComoAssistido(4)"></video>
      </div>
    </div>
  </section>
</template>
