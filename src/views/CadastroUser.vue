<template>
  ...
  >
    ...
    <p
      v-if="respostaFeedback"
      class="retorno-feedback"
      :class="respostaFeedback.tipo"
    >
...
async function enviarFormulario() {
  ...
  try {
    const { error } = await conexaoSupabase.auth.signUp({
    ...
    respostaFeedback.value = {
      tipo: 'sucesso',
      mensagem:
        'Cadastro realizado com sucesso! Verifique seu e-mail para confirmar sua conta antes de fazer login.'
    }
