  ...
  // ================= 1º ANO =================
  {
    ...
    quizzes: [
      ...
      // -----QUIZ 2-----
      {
        ...
        descricao:
          'Do primeiro índice ao último elemento, prove que você sabe navegar, modificar e manipular arrays!',
        perguntas: [
          {
            id: 1,
            nivel: 'Fácil',
...
`,
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              '2. Qual método do JavaScript é utilizado para adicionar um ou mais elementos ao início de um array e retorna o novo comprimento desse array?',
            alternativas: [
              'A) array.push()',
              'B) array.unshift()',
              'C) array.pop()',
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              ' Qual código é o certo? Você tem um array de números chamado numeros e precisa criar um novo array contendo apenas os números que sejam maiores que 10. Qual das opções abaixo realiza essa tarefa corretamente sem modificar o array original?',
            alternativas: [
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'No JavaScript, vários métodos de array alteram o array original (mutação), enquanto outros retornam uma cópia ou um novo valor. Qual dos métodos abaixo NÃO altera o array original ao ser invocado?',
            alternativas: [
      ...
      // -----QUIZ 3-----
      {
        ...
        descricao:
          'Descubra se você domina for, while, do...while e sabe quando cada um deles entra em ação!',
        perguntas: [
          {
            id: 1,
            nivel: 'Fácil',
            pergunta:
              ' Se você quiser passar por todos os itens de um array, pegando apenas o valor de cada um sem se preocupar em criar contadores ou controlar a posição (como a variável i), qual estrutura de repetição é a melhor escolha no JavaScript',
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              ' Observe o código abaixo utilizando a estrutura while. Qual será o último número impresso no console antes do loop terminar?',
...
`,
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              ' Qual código é o certo? Você precisa imprimir no console os números de 10 até 1, em ordem decrescente. Qual dos blocos de código abaixo realiza essa tarefa corretamente sem causar um loop infinito?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              ' O que será exibido no console após a execução do seguinte trecho de código?',
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Qual será o valor final da variável soma impresso no console após a execução do loop abaixo?',
            codigo: `let soma = 0;
for (let i = 1; i <= 5; i++) {
  if (i === 3) continue;
  soma += i;
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Analise o uso do operador de incremento dentro da própria condição do while. Quais valores serão exibidos no console?',
            codigo: `let x = 0;
while (x++ < 3) {
  console.log(x);
}
    ...
    quizzes: [
      {
        ...
        descricao:
          'Do SELECT ao JOIN, descubra se você domina os principais conceitos de banco de dados!',
        perguntas: [
          {
            id: 1,
            nivel: 'Fácil',
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Qual linguagem é utilizada para consultar e manipular dados em bancos de dados relacionais?',
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              "Em um banco de dados relacional, qual consulta retorna apenas os nomes dos clientes cujo estado seja 'SC'?",
            alternativas: [
        ...
        perguntas: [
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Qual diretiva do Vue.js é usada para exibir um elemento na tela apenas se uma condição for verdadeira? ',
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Como você escuta um evento de clique em um botão para executar uma função chamada salvar no Vue.js?',
            alternativas: [
              'A) v-click="salvar"',
              'B) @click="salvar"',
              'C) bind:click="salvar"',
              'D) click-event="salvar"',
            ],
            respostaCorreta: 1,
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              'Considere o código abaixo e responda: Qual é o principal cuidado ao tentar usar v-for e v-if juntos no mesmo elemento no Vue.js?',
            codigo: `<template>
  <ul>
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Qual é a principal diferença prática entre usar uma propriedade computed e um método comum (methods) para exibir dados formatados no template do Vue?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'No Vue.js, para que serve um modificador de evento como o .prevent (por exemplo: @submit.prevent="enviar")?',
            alternativas: [
      ...
      },
      {
        ...
        descricao:
          'Responda às perguntas e veja se você está preparado para encarar mais uma sprint sem impedimentos.',
        perguntas: [
          {
            id: 1,
            nivel: 'Fácil',
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Qual é a principal responsabilidade do Scrum Master em relação ao time de desenvolvimento e à organização?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Durante a Reunião de Revisão da Sprint (Sprint Review), o que deve acontecer primordialmente? ',
            alternativas: [
    ...
    quizzes: [
      {
        ...
        descricao:
          'Está na hora de colocar seus conhecimentos à prova e descobrir se você realmente aprendeu a linguagem!',
        perguntas: [
          {
            id: 1,
            nivel: 'Fácil',
            pergunta:
              'Qual função nativa do Python é utilizada para exibir mensagens ou valores no terminal durante a execução de um programa?',
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Observe o código a seguir que manipula um dicionário em Python e responda: Qual será o resultado exibido no console?',
            codigo: `usuario = {"nome": "Lucas", "idade": 20}
print(usuario.get("email", "não informado"))
`,
            alternativas: ['A) None', "B) KeyError: 'email'", 'C) não informado', 'D) email'],
            respostaCorreta: 2,
          },
          {
            id: 3,
            nivel: 'Médio',
            pergunta:
              'Qual código é o certo? Você precisa aplicar um decorador de autenticação chamado login_required em uma função de página web. Qual das opções abaixo representa a sintaxe correta de uso de um decorador em Python?',
            alternativas: [
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              ' Analise o bloco de código a seguir e determine qual será o valor impresso no console ao final da execução:',
            codigo: `try:
    valor = int("10b")
except ValueError:
    valor = 0
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Ao preparar um projeto Python/Django para ser implantado em outro servidor, qual sequência de comandos via terminal é a prática padrão para gerar o registro de dependências instaladas e depois instalá-las no novo ambiente?',
            alternativas: [
      ...
      },
      {
        ...
        descricao:
          'Teste seus conhecimentos sobre os conceitos que fazem a Programação Orientada a Objetos funcionar!',
        perguntas: [
          {
            id: 1,
            nivel: 'Fácil',
            pergunta:
              'Na Programação Orientada a Objetos, qual é a relação conceitual básica entre uma Classe e um Objeto?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Qual pilar da POO é responsável por esconder os detalhes internos de funcionamento de um objeto, expondo apenas o necessário e protegendo seus dados contra alterações indevidas?',
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              'Qual código é o certo? Em Python, você precisa criar uma classe Cachorro que herde todos os atributos e métodos de uma classe base chamada Animal. Qual é a sintaxe correta para declarar essa herança?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              'Observe a definição da classe abaixo em Python e responda: O que a palavra self representa dentro do método __init__ e dos demais métodos da classe?',
            codigo: `class Pessoa:
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Qual será o resultado impresso no console após a execução do código a seguir?',
...
`,
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              ' Em Python, quando utilizamos o decorador @classmethod em um método dentro de uma classe, qual é a principal característica desse método?',
            alternativas: [
        ...
        perguntas: [
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Qual comando do CLI é utilizado para criar um novo aplicativo (app) dentro de um projeto Django existente?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Fácil',
            pergunta:
              'Na arquitetura MVT (Model-View-Template) nativa do Django, qual componente é responsável por definir a estrutura dos dados e a lógica de negócios com o banco de dados?',
            alternativas: ['A) View', 'B) Template', 'C) Model', 'D) Controller'],
            respostaCorreta: 2,
          },
          {
            id: 3,
            nivel: 'Médio',
            pergunta:
              'Qual código é o certo? Você precisa buscar todos os registros do model Produto cujo preço seja estritamente maior que 50. Qual instrução do ORM do Django realiza essa consulta corretamente?',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Médio',
            pergunta:
              'Observe a definição de rota no arquivo urls.py e responda: Como a função da view detalhe_artigo receberá o valor capturado nessa URL? ',
            alternativas: [
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Ao trabalhar com relacionamentos do tipo chave estrangeira (ForeignKey / OneToOne), qual método do QuerySet realiza um JOIN SQL na consulta original para evitar o problema de N+1 queries?',
            alternativas: [
              'A) prefetch_related()',
              'B) annotate()',
              'C) select_related()',
          ...
          },
          {
            ...
            nivel: 'Difícil',
            pergunta:
              'Qual é a responsabilidade exata do comando python manage.py makemigrations no fluxo de trabalho do Django?',
            alternativas: [
