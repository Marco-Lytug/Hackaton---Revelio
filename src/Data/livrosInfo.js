export const livrosInfo1Ano = [
  {
    //INICIO DOS LIVROS DO 1° ANO DE INFO
    id: 'info-1',
...

  {
    ...
    autor: 'Lucas Mazza',
    descricao:
      'Um livro excelente e prático focado na estruturação moderna com HTML5 e na estilização elegante utilizando folhas de estilo CSS3.',
...

  {
    ...
    descricao:
      'E-book desenhado para quem está dando os primeiros passos no desenvolvimento, ensinando algoritmos com foco prático no VisuAlg.',
...
export default { livrosInfo1Ano, livrosInfo2Ano, livrosInfo3Ano }
